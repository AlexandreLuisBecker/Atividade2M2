...
export default function CreateAutor({navigation, ...props}) {
      ...
      const onAddButtonPress = () => {
        ...
        const timeStamp = firebase.firestore.FieldValue.serverTimestamp()
          ...
          // recuperando o ID do usuário no Firebase
            ...
            const usersRef = firebase.firestore().collection('Autor')
            ...
            usersRef
              ...
              .then(() => {
                ...
                // página
                navigation.navigate('Autor', { Genero: data })
              })
              .catch(error => {
                alert(error)
              })
  ...
  >
       <LinearGradient colors={['#0000CD', '#87CEFA', '#fff']}>
        ...
        <View style={styles.footerView}>
          <Text style={styles.textCadastro}>Criação Autor</Text>
        </View>
        <TextInput
          style={styles.input}
          placeholder="Nome"
